...
namespace vptree::tests
{
    TEST(VPTests, TestHamming) {
        ...
        std::vector<unsigned char> b12 = {
              1, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255};

        std::vector<unsigned char> b22 = {
        ...
        std::vector<unsigned char> b15 = {
            255, 255, 255, 255, 255, 253, 255,   9,
            255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255
        };
        std::vector<unsigned char> b25 = {
